...
const BADGE = { paid: ['ae-badge ae-badge-green', 'Opłacona'], pending: ['ae-badge ae-badge-orange', 'Oczekująca'], overdue: ['ae-badge ae-badge-red', 'Zaległa'] };
    ...
    <React.Fragment>
      ...
      <div className="ae-finance">
        <div className="ae-finance-header">
          <div>
            <div className="ae-page-title" style={{fontSize:22,fontWeight:700,color:'#050505',marginBottom:2}}>Finanse</div>
            <div className="ae-page-sub" style={{fontSize:13,color:'rgba(5,5,5,0.45)'}}>Zarządzanie płatnościami i fakturami</div>
          </div>
        </div>
