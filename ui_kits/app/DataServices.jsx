...
const DataServicesStyles = `
  ...
  .ae-search-inline { display: flex; align-items: center; gap: 7px; background: #fff; border: 1px solid rgba(20,20,20,0.12); border-radius: 8px; padding: 0 11px; height: 30px; width: 220px; transition: border-color 150ms, box-shadow 150ms; }
  .ae-search-inline:focus-within { border-color: #7448D0; box-shadow: 0 0 0 3px rgba(116,72,208,0.10); }
  ...
  return (
    <React.Fragment>
      ...
      <div className="ae-data">
        ...
        <div className="ae-section-label" style={{marginTop:0}}>Pracownicy ({filtered.length})</div>
